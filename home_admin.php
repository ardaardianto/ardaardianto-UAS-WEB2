...
<body>
		<div class="content">
			...
			<div class="menu">
				<ul>
					<li><a href="home_admin.php?page=form">TAMBAH DATA</a></li>
					<li><a href="home_admin.php?page=data">DATA BANTUAN</a></li> 
					<li><a href="home_admin.php?page=logout">LOGOUT</a></li>
				</ul>
		</div>
